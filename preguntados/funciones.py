...
def mostrar_pregunta(pregunta, opciones, puntos, vidas):
...
def guardar_partida(nombre, puntos, vidas, duracion):
...
def mostrar_mensaje_fin(nombre, puntos, vidas, duracion):
    pantalla.fill(FONDO)
