        ...
        for evento in pygame.event.get():
            if evento.type == pygame.QUIT:
                ...
                if boton_cantidad_de_puntos_facil.collidepoint(mouse_posicion):
                    config_puntos_facil(pantalla, fuente_puntos, cantidad_de_puntos_facil)
                if boton_cantidad_de_puntos_intermedio.collidepoint(mouse_posicion):
                    config_puntos_intermedio(pantalla, fuente_puntos, cantidad_de_puntos_intermedio)
                if boton_cantidad_de_puntos_dificil.collidepoint(mouse_posicion):
                    config_puntos_dificil(pantalla, fuente_puntos, cantidad_de_puntos_dificil)
